...
imsrg_F_1 = "data/imsrg_four_sp4.txt"
imsrg_F_2 = "data/imsrg_four_sp8.txt"
imsrg_F_3 = "data/imsrg_four_sp12.txt"
F_imsrg = [imsrg_F_1,imsrg_F_2,imsrg_F_3]
F_fig_I = ["imsrg SP orbits: 4","imsrg SP orbits: 8","imsrg SP orbits: 12"]
...
for file in F_imsrg[0:1]:
    ...
    while i<len(data_four_t):
        ...
        data[1][i]=data_four_t[i][1]
        i+=1
    plt.plot(data[0],data[1],'*', linewidth=3, label=F_fig_I[f])
